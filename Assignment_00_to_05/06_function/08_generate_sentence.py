...
def main():
    ...
    try:
        part_of_speech = int(input("Is this a noun, verb, or adjective? Type 0 for noun, 1 for verb, 2 for adjective: ").strip())
        make_sentence(word, part_of_speech)  # Call the function
    except ValueError:
        print("Invalid input. Please enter a single number (0, 1, or 2).")
